...
import { Avatar, Typography, Paper, Grid, Stack, CardActionArea } from "@mui/material";
    ...
    return (
        <>
          ...
          <Grid container sx={{paddingX: 1}} >
            {/* <Grid item xs={5} sm={3} sx={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            </Grid> */}

            <Grid item xs sx={{display: 'inline-flex', alignItems: 'center'}}>
                <Avatar src={user.profileImg} sx={{width: 100, height: 100, margin: 1}} />
